...
public class AmwsOrderImpl implements Order, AdminMainEntity, CurrencyCodeIdentifiable, Previewable {
    ...
    @Index(name="ORDER_SOURCE_INDEX", columnNames={"ORDER_SOURCE"})
    @AdminPresentation(friendlyName = "OrderImpl_Order_Source", group = Presentation.Group.Name.General,
            order=Presentation.FieldOrder.ORDERSOURCE, groupOrder = Presentation.Group.Order.General)
    ...
    @OneToOne(mappedBy = "order", targetEntity = OrderAmazonAdditionalImpl.class, cascade = {CascadeType.MERGE, CascadeType.PERSIST})
    @Cache(usage = CacheConcurrencyStrategy.NONSTRICT_READ_WRITE, region="blOrderElements")
    @AdminPresentation(friendlyName="OrderImpl_AmazonAdditional")
    protected OrderAmazonAdditional orderAmazonAdditional = new OrderAmazonAdditionalImpl();
    ...
    public OrderAmazonAdditional getOrderAmazonAdditional() {
        return orderAmazonAdditional;
    }

    public void setOrderAmazonAdditional(OrderAmazonAdditional orderAmazonAdditional) {
        this.orderAmazonAdditional = orderAmazonAdditional;
    }
    ...
    public boolean equals(Object obj) {
        ...
        AmwsOrderImpl other = (AmwsOrderImpl) obj;
    ...
    public static class Presentation {
        public static class Tab {
            public static class Name {
                public static final String AmazonAdditional = null;
            ...
            public static class Order {
                public static final int AmazonAdditional = 0;
        ...
        public static class FieldOrder {
            ...
            public static final int ORDERSOURCE = 11000;
